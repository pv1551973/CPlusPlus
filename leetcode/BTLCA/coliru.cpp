...
void createNodeLLFromArray(int* pArray, size_t numElems)
{
  ...
  for(size_t count = 0; count < numElems/2; ++count)
    ...
    upNodeArray[count].val = *(pArray + count);
	 	//dbg
   	#ifdef DBG
	 	cout << "upNodeArray[count] = " << upNodeArray[count].val << endl;
    #endif
		...
		if(parentIdx >= 0)
		{
	 	  ...
	 	  //dbg
   	  #ifdef DBG
	 	  cout << "upNodeArray[parentIdx] = " << upNodeArray[parentIdx].val << endl;
	 	  cout << endl;
      #endif
		}
		else
		{
	 	  ...
	 	  //dbg
   	  #ifdef DBG
	 	  cout << "upNodeArray[parentIdx] =  NULL" << endl;
	 	  cout << endl;
      #endif
		}
		...
		if(lIdx < numElems)
		{
     	...
     	upNodeArray[lIdx].val = *(pArray + lIdx);
  		  ...
  		  //dbg
        #ifdef DBG
	  		cout << "upNodeArray[lIdx] = " << upNodeArray[lIdx].val << endl;
	  		cout << "upNodeArray[parentIdx] = " << upNodeArray[parentIdx].val << endl;
	    	cout << endl;
        #endif
			}
    ...
    else
    {
      //dbg
      #ifdef DBG
	  	cout << "upNodeArray[lIdx] = NULL" << endl;
	   	cout << endl;
      #endif
    }
		...
		if(rIdx < numElems)
		{
     	...
     	upNodeArray[rIdx].val = *(pArray + rIdx);
  		  ...
  		  //dbg
    		#ifdef DBG
	  		cout << "upNodeArray[rIdx] = " << upNodeArray[rIdx].val << endl;
	  		cout << "upNodeArray[parentIdx] = " << upNodeArray[parentIdx].val << endl;
	    	cout << endl;
		   #endif
			}
    ...
    else
    {
      //dbg
      #ifdef DBG
	  	cout << "upNodeArray[rIdx] = NULL" << endl;
	   	cout << endl;
      #endif
    }
